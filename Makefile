...
npm:
	...
	echo "try { global[\"crypto\"] = require(\"crypto\"); module[\"exports\"] = require(\"@nicolasflamel/secp256k1-zkp-native\");} catch(error) {} if(Object.keys(module[\"exports\"])[\"length\"] === 0) { const secp256k1Zkp = (typeof WebAssembly !== \"undefined\") ? require(\"./wasm.js\") : require(\"./asm.js\");" > "./index.js"
